...
test("Legacy-Routen laden dasselbe Theme früh und ohne Inline-Skript", function () {
    ...
    assert.ok(
        indexHtml.indexOf("/js/core/theme.js?v=52") <
            indexHtml.indexOf("/css/style.css?v=52")
    );
    assert.ok(
        systemHtml.indexOf("/js/core/theme.js?v=52") <
            systemHtml.indexOf("/css/style.css?v=52")
    );
    assert.equal(
    ...
    assert.match(indexHtml, /\/js\/app\.js\?v=52/);
    assert.match(systemHtml, /\/js\/system\/summary\.js\?v=52/);
    assert.match(systemHtml, /\/js\/system\/errors\.js\?v=52/);
});
