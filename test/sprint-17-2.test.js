...
test("Legacy-Routen laden dasselbe Theme früh und ohne Inline-Skript", function () {
    ...
    assert.ok(
        indexHtml.indexOf("/js/core/theme.js?v=24") <
            indexHtml.indexOf("/css/style.css?v=24")
    );
    assert.ok(
        systemHtml.indexOf("/js/core/theme.js?v=24") <
            systemHtml.indexOf("/css/style.css?v=24")
    );
    assert.equal(
    ...
    assert.match(indexHtml, /\/js\/app\.js\?v=24/);
    assert.match(systemHtml, /\/js\/system\/summary\.js\?v=24/);
    assert.match(systemHtml, /\/js\/system\/errors\.js\?v=24/);
});
