...
| RQ-13-01 | 24, 25 | Die konfigurierte App-Version und das veröffentlichte GHCR-Image bilden nicht den aktuell auditierten Repositorycode ab. | BROKEN | P1 | Ausgangsstand `a5d433c`: aktive Version `1.0.0-rc.3` war korrekt an `771683b` gebunden, spätere Reparaturen lagen nur auf HEAD. Sprint 27.1-J ergänzte Source-/Tag-/Immutable-Target-Gates. Der separate Publishlauf erzeugte RC.7 auf `2507f6955b17740da8edbd36925b3338ca080383`; Workflow `34838365619` bestand Testgate, Browsermatrix, Dependency-Audit, amd64/aarch64, Manifest, Smoke-Test, Kandidatennachweis und Prerelease. Manifestdigest `sha256:050044307676e5263652e609379bd8eb331bc76a41a8341fb06f88320380037e`. | **UMGESETZT UND VERÖFFENTLICHT.** Aktive App-Version, Git-Tag, Sourcecommit, GHCR-Multi-Arch-Manifest, Release Notes und Standalone-Artefakt bilden denselben RC.7-Stand ab. RC.4–RC.6 wurden nach real gefundenen Pipelinefehlern nicht verschoben oder wiederverwendet. | Automations-/Distributionsblocker geschlossen. Reale HAOS-/LXC-/iPad-Abnahmen bleiben kandidatenbezogen `NOT TESTED`; RC.7 ist nicht Stable. | CLOSED – RC.7 RELEASE EVIDENCE PASS / MANUAL PENDING |
...
| RQ-17-01 | 25.4 | Die lebende RC-Checkliste ist kein commit- und artefaktkohärenter Nachweis mehr und enthält veraltete beziehungsweise aktuell falsche PASS-Aussagen. | BROKEN | P1 | Sprint 27.1-J trennte historische Evidenz und implementierte den Generator. RC.7 veröffentlichte `rc-result.json`/`.md` mit genau Tag `v1.0.0-rc.7`, Commit `2507f6955b17740da8edbd36925b3338ca080383`, Manifestdigest `sha256:050044307676e5263652e609379bd8eb331bc76a41a8341fb06f88320380037e`, Bundle-SHA256 `eac0df3c709d4663819167fe0eb1eff23164b40e92f103f691d7550f7eccfa10` und Workflow `34838365619`. Reale Umgebungen beginnen darin weiterhin `NOT TESTED`. | **UMGESETZT UND BELEGT.** Checkliste und veröffentlichter Nachweis sind kandidatenkohärent; historische RCs werden nicht vermischt. | Kandidatennachweis geschlossen. RC-Empfehlung bleibt nur wegen der noch ausstehenden realen MT-50–57/61–66 und weiteren iPad-Tests `BLOCKED`. | CLOSED – RC.7 CANDIDATE EVIDENCE PASS / MANUAL PENDING |
...
| RQ-13-01 | Versionen, Tag/Commit, GHCR, App-Image, Release Notes | CLOSED | YES | RQ-14-04; RQ-18-01 erfüllt | aktuelle HAOS-/Release-Abnahme | MT-50–55/57/61/62/64–66/70 | Sprint 24, 25, 25.4 – re-auditiert | RC.7 RELEASE EVIDENCE PASS / MANUAL PENDING |
...
| RQ-17-01 | commit-/artefaktkohärente RC-Checkliste und Blockerableitung | CLOSED | NO | RQ-08-03, RQ-14-04 und RQ-13-01 erfüllt | reale kandidatengebundene Abnahme | MT-50–57/61–66 | Sprint 25.4 – re-auditiert | RC.7 CANDIDATE EVIDENCE PASS / MANUAL PENDING |
