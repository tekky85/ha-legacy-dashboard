...
- Code repairs completed: 2 (`RQ-16-01`, `RQ-04-01`)
- Open code repairs: 23
- P0: 0
- P1 open: 5
...
- Repairs blocking manual tests: 12
- Repairs with dependencies: 8
- Status: **SPRINT 27.1-A UND 27.1-B COMPLETE – MANUAL PENDING**
...
| RQ-04-01 | 17.2, 17.3, 17.4, 17.5, 17.6, 17.7, 18, 19, 20, 21, 21.1, 21.2, 21.3, 21.4, 21.5, 22, 23, 24, 25, 25.1, 25.2, 25.3, 25.4, 25.5, 25.6, 25.7, 26, 26.1, 26.2 | Gemeinsam genutzte Legacy-Assets besaßen zwischen Dashboard, Systemseiten, Admin und Manifest unterschiedliche Cache-Buster. | PARTIAL | P1 | Ausgangsstand auf `3830259`: Dashboard v51, System v44, Admin v50 und Manifesticons v44 bei immutable Public-Assets. Sprint 27.1-B setzt sämtliche Assetreferenzen in `src/public/index.html`, `src/public/system.html`, `src/admin/index.html` und `src/public/manifest.json` auf v52. `test/asset-version.test.js` erzwingt eine einzige, gegenüber v51 erhöhte Version und prüft gemeinsame Theme-, Style-, Compat-, Navigation-, Icon- und Presentation-Assets. Fokussiert 46/46, Gesamtsuite 331/331 PASS. | **UMGESETZT.** Alle Entry Points und das Manifest verwenden v52; die Gleichheitsregression verhindert erneute routeabhängige Abweichungen. Immutable Header und Anwendungslogik bleiben unverändert. | Code-/Automationsgate erfüllt. Reale iOS-9-/HomeScreen-/Safari-Cache-, LXC- und HAOS-Abnahmen bleiben `NOT TESTED`; keine RC-Freigabe abgeleitet. | CODE CLOSED / MANUAL PENDING – Sprint 27.1-B; 29 betroffene Audits re-auditiert |
...
- `RQ-04-01` – **CODE CLOSED / MANUAL PENDING** (Sprint 27.1-B):
  Dashboard, System, Admin und Manifest auf v52 vereinheitlicht und durch
  `test/asset-version.test.js` geschützt; Fokus 46/46, Gesamtsuite 331/331.
...
- Offene Code-Repair-Einträge: 23; zusätzlich zwei code-seitig geschlossene,
  manuell noch nicht abgenommene Einträge (`RQ-04-01`, `RQ-16-01`).
- Offene Prioritäten: P0 0, P1 5, P2 18, P3 0.
