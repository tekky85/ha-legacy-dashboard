...
- Veröffentlichte aktuelle Version: `1.0.0-rc.3`
- Veröffentlichter aktueller Tag: `v1.0.0-rc.3`, Commit
  `771683b804f0b7c684eb3d457b58fb579a3ccdb6`
...
- Releaseart: GitHub Prerelease/Public Test Release; niemals Stable oder
  `latest`.
- Veröffentlichte Artefakte: generisches GHCR-Multi-Arch-Manifest für
  amd64/aarch64, Standalone-Tar und `SHA256SUMS`.
...
- Status: **COMPLETE – PUBLIC TESTS PENDING**.
...
- `rc.3`-Evidenz: fokussiert 87/87 und vollständig 340/340 Tests; Version,
  Secret, Legacy-Syntax und Produktionsaudit grün. Release-Workflow
  `34471183386` bestand Validate, amd64, arm64, Manifest, Container-Smoke und
  Prerelease. Das GHCR-Manifest hat Digest
