# Sprint 27.1-E – Repairs & Re-Audits

## Codex-Ausführungsanweisung

```text
Execute Sprint 27.1-E only.
...
- every audit file referenced by RQ-07-01
- every audit file referenced by RQ-08-01
- every audit file referenced by RQ-09-02
- every audit file referenced by RQ-10-01
...
5. Resolve and summarize the canonical definitions of:
   ...
   - RQ-09-02
   - RQ-10-01
6. List affected Sprints, files/components, dependencies, acceptance criteria,
   security-sensitive aspects, RC relevance, audit files to re-audit,
   automated tests available and manual tests currently blocked.
...
Execute the canonical repair defined for RQ-07-01.
...
Execute the canonical repair defined for RQ-08-01.

If this item shares implementation with RQ-07-01, RQ-09-02 or RQ-10-01:
...
Execute the canonical repair defined for RQ-09-02.

Verify:
- its own acceptance criteria
- interaction with RQ-07-01
- interaction with RQ-08-01
- interaction with RQ-10-01
- no regression in previously repaired batches where shared code is touched

RQ-10-01

Execute the canonical repair defined for RQ-10-01.

Verify:
- its own acceptance criteria
- shared-root-cause implications
- no regression of the other 27.1-E repairs
...
PUBLIC TEST RELEASE REGRESSION CHECK
...
ACCEPTANCE GATE – 27.1-E

Before commit verify ALL of the following:
- RQ-07-01 acceptance criteria satisfied as far as automatable
- RQ-08-01 acceptance criteria satisfied as far as automatable
- RQ-09-02 acceptance criteria satisfied as far as automatable
- RQ-10-01 acceptance criteria satisfied as far as automatable
...
- git diff contains only intended Batch 27.1-E changes

If any acceptance item fails:
- do NOT present Batch 27.1-E as complete
...
COMMIT & PUSH – BATCH 27.1-E

If the 27.1-E acceptance gate passes:
...
Stage ONLY:
- product changes required for RQ-07-01
- product changes required for RQ-08-01
- product changes required for RQ-09-02
- product changes required for RQ-10-01
...
git commit -m "fix(audit): repair RQ-07-01 RQ-08-01 RQ-09-02 and RQ-10-01"
...
1. starting commit
2. branch
3. canonical definition summary for RQ-07-01
4. canonical definition summary for RQ-08-01
5. canonical definition summary for RQ-09-02
6. canonical definition summary for RQ-10-01
7. dependency/order decision inside 27.1-E
...
46. 27.1-E acceptance gate result
47. commit hash
48. push result
...
Do NOT start Sprint 27.1-F automatically.
```
...
git diff --check
git diff
git add <nur Dateien für RQ-07-01, RQ-08-01, RQ-09-02, RQ-10-01 und zugehörige Tests/Audit-Dokumentation>
git commit -m "fix(audit): repair RQ-07-01 RQ-08-01 RQ-09-02 and RQ-10-01"
git push
```
